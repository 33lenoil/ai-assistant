        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {location.photos.map((photo, index) => (
            ...
            >
              ...
              <Image
                src={photo}
                alt={`${location.displayName} photography - ${location.description}. Photo ${index + 1} of ${location.photos.length} showcasing ${location.category} scenery and landscapes.`}
                fill
              ...
              <div className="relative w-full h-full flex items-center justify-center p-16">
                ...
                >
                  <Image
                    ...
                    alt={`Full-size view of ${location.displayName} photography - ${location.description}. Photo ${selectedImageIndex + 1} of ${location.photos.length} in lightbox gallery showcasing ${location.category} scenery.`}
                    fill
